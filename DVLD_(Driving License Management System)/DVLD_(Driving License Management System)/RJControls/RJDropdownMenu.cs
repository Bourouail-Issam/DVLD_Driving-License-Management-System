...
namespace DVLD__Driving_License_Management_System_.RJControls
{
    public class RJDropdownMenu : ContextMenuStrip
    {
        ...
        private void LoadMenuItemHeight()
        {
            ...
            foreach (ToolStripItem itemL1 in this.Items)
            {
                if (itemL1 is ToolStripMenuItem menuItemL1)
                {
                    ...
                    {
                        if (itemL2 is ToolStripMenuItem menuItemL2)
                        {
                            ...
                            {
                                if (itemL3 is ToolStripMenuItem menuItemL3)
                                {
                                    ...
                                    {
                                        if (itemL4 is ToolStripMenuItem menuItemL4)
                                        {
